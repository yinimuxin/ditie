...
<form id="mainfrom" class="layui-form" style="width:80%;">
  ...
  <div class="layui-form-item layui-row layui-col-xs12">
    ...
    <div class="layui-input-block">
      <input type="text" name="name" class="layui-input width400 name" value="<?php echo ($data["name"]); ?>" lay-verify="required" placeholder="请输入站点名称">
    </div>
  </div>
  ...
  <div class="layui-form-item layui-row layui-col-xs12">
    ...
    <div class="layui-input-block">
      <input type="number" name="sort" class="layui-input width400 sort" value="<?php echo ($data["sort"]); ?>" lay-verify="required" placeholder="请输入顺序">
    </div>
  </div>
