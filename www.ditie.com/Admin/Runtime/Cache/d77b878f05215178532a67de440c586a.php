...
layui.use(['form','layer','table','laytpl','util'],function(){
    ...
    var tableIns = table.render({
        elem: '#List',
        url : '/admin.php/Station/getList?mid='+$("#mid").val(),
        cellMinWidth : 95,
        height : "full-125",
        id : "ListTable",
        cols : [[
            {field: 'name', title: '站点名称', minWidth:100, align:'center'},
            {field: 'mname', title: '所属线路', minWidth:100, align:'center'},
            {field: 'sort', title: '顺序', minWidth:100, align:'center'},
