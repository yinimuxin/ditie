...
<form id="mainfrom" class="layui-form" style="width:80%;">
  ...
  <div class="layui-form-item layui-row layui-col-xs12">
    ...
    <div class="layui-input-block">
      <input type="number" name="age" class="layui-input width200 age" value="<?php echo ($data["age"]); ?>" lay-verify="required" placeholder="请输入年龄">
    </div>
  </div>
    ...
    <div class="layui-form-item layui-row layui-col-xs12">
      ...
      <div class="layui-input-block" style="display: flex; align-items: center;">
        <select id="sex" name="sex">
              <option value="男" <?php if($data['sex'] == '男'): ?>selected='selected'<?php endif; ?>>男</option>
              <option value="女" <?php if($data['sex'] == '女'): ?>selected='selected'<?php endif; ?>>女</option>
        </select>
      </div>
    </div>
  ...
  <div class="layui-form-item layui-row layui-col-xs12">
    ...
    <div class="layui-input-block">
      ...
      <input type="hidden" name="zhiye" value="<?php echo ($data["zhiye"]); ?>">
    </div>
  </div>
  ...
  <div class="layui-form-item layui-row layui-col-xs12">
    ...
    <div class="layui-input-block">
      <input type="text" name="content" class="layui-input width600 content" value="<?php echo ($data["content"]); ?>" lay-verify="required" placeholder="请输入备注">
    </div>
  </div>
