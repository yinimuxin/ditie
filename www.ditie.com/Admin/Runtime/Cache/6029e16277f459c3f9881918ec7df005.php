...
<body>
    ...
    <script type="text/html" id="ListBar">
        <a class="layui-btn layui-btn-xs layui-btn-normal" lay-event="station">站点列表</a>
...
layui.use(['form','layer','table','laytpl','util'],function(){
    ...
    var tableIns = table.render({
        ...
        cols : [[
            ...
            {field: 'name', title: '线路', minWidth:100, align:'center'},
            {field: 'date', title: '时间', minWidth:100, align:'center'},
            {field: 'startname', title: '起始站', minWidth:100, align:'center'},
            {field: 'endname', title: '终点站', minWidth:100, align:'center'},
    ...
    function station(data){
        var index = layui.layer.open({
            title : "站点列表",
            type : 2,
            content : "/admin.php/Station/index?id="+data.id,
            success : function(layero, index){
                var body = layui.layer.getChildFrame('body', index);
                form.render();
                setTimeout(function(){
