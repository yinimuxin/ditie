...
<form id="mainfrom" class="layui-form" style="width:80%;">
  ...
  <div class="layui-form-item layui-row layui-col-xs12">
    ...
    <div class="layui-input-block">
      <input type="text" name="name" class="layui-input width400 name" value="<?php echo ($data["name"]); ?>" lay-verify="required" placeholder="请输入线路">
    </div>
  </div>
  ...
  <div class="layui-form-item layui-row layui-col-xs12">
    ...
    <div class="layui-input-block">
      <input type="text" name="date" class="layui-input width400 date" value="<?php echo ($data["date"]); ?>" lay-verify="required" placeholder="请输入时间">
    </div>
  </div>
  ...
  <div class="layui-form-item layui-row layui-col-xs12">
    ...
    <div class="layui-input-block">
      <input type="text" name="startname" class="layui-input width400 startname" value="<?php echo ($data["startname"]); ?>" lay-verify="required" placeholder="请输入起始站">
    </div>
  </div>
  ...
  <div class="layui-form-item layui-row layui-col-xs12">
    ...
    <div class="layui-input-block">
      <input type="text" name="endname" class="layui-input width400 endname" value="<?php echo ($data["endname"]); ?>" lay-verify="required" placeholder="请输入终点站">
    </div>
  </div>
